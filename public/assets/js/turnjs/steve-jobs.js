...
*/
	...
	$.ajax({
		url: '/Mypage/turnjs/' + cc,
		//url: '/Mypage/turnjs/',
		/*data : {cc:cc},*/
		success : function(pageHtml){
			var pageNum = 'page' + page;
			var pagenn = '\''+'#'+'page' + page + '\'';
			...
			// var ss = $(this).$('#page5').html();
			// alert(pageHtml);
			// alert(pageHtml);
			// alert(pagenn);
			//var xx = $(pageHtml).find(pagenn);
			var yy = $(pageHtml).filter(pagenn);
			$('.sj-book .p' + page).html(yy);
			...
			//$('.sj-book .p' + page).html(e);
			//$('.sj-book .p' + page).html(e);
			//$('.sj-book .p' + page).html(e);
			//$('.own-size.page.p5.odd').html(e);
		},
