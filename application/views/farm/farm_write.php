...
<section id="farm_write">
    <form name="farm_write_form" method="post" action="/Farm/farmWriteDB" encType="multipart/form-data">
        <table>
            <tr align="center">
                <td rowspan="4" style="padding: 15px"><img id="Uploadedimg" src="../public/assets/img/default.jpg"
                                     width="300" height="300"><br><input type="file" name="picName" onchange="readURL(this);"></td>
                <td colspan="2">生産地名 <input type="text" name="fname" placeholder="取引先名を入力してください。"></td>
            </tr>
            <tr align="center">
                <td colspan="2">名前 <input type="text" name="farmer"></td>
                <input type="hidden" name="uno" value="<?= $user_info->uno ?>">
            </tr>
            <tr align="center">
                <td colspan="2">カラー <input type="color" name="fcolor"></td>
            </tr>
            <tr><td colspan="2">電話番号 <input type="text" name="fphone" placeholder="電話番号を入力してください。"></td></tr>
            <tr align="center">
                <td colspan="2">
                    住所
                </td>
            ...
            <tr>
                <td><input type="text" size="50" id="flocation" name="flocation" placeholder="住所を入力してください。" style="height: 10px;"/>
                    <input type="text" id="position" name="position" style="display: none;"></td>
                <td><input style="padding: 5px; font-size: 80%" name="submit" type="submit" value="주소 검색" onclick='codeAddress(); return false;' /></td>
            </tr>
        </table>
        <div id="map_canvas" style="margin-top: 20px; margin-bottom: 50px; width: 900px; height: 500px;"></div>
        <div>
            <p>紹介</p>
            <textarea name="fintro" placeholder="紹介を入力してください。" rows="5"></textarea>
        </div>
        <p><input type="submit" name="submit_farm_write" value="登録"><input type="button" value="キャンセル"
